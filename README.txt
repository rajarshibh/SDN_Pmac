...
3. Compile test.c
4. Run glomosim as usual. No configuration needed.
5. For MAC-Switch, execute test object file while the simulation is running
5. glomo.stat contains the results for both CSMA and Wifi protocols
